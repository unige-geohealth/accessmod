...
#' @export
amScalingUpCoef_traveltime <- function(
  inputMask,
  inputMap,
  inputSpeed,
  inputFriction,
...
#' @export
amScalingUpCoef_generic <- function(
  inputMask,
  inputMap,
  weight = 1,
  inverse = FALSE
...
#' @export
amScalingUp_createCandidatesTemp <- function(
  input = NULL,
  output = NULL
  ){
...
amScalingUp_extractBest <- function(
  listEvalCoverage,
