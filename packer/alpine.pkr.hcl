...
variable "local_key" {
   type = string
   default = "ssh-rsa  worker@mbp-worker.home"
...
source "virtualbox-iso" "autogenerated_1" {
  boot_command = [
    ...
    "export ROOTSSHKEY='{{ .SSHPublicKey | urlquery }}'<enter>", 
    "export USERSSHKEY='${var.local_key}'<enter>",
    ...
    "echo 'PubkeyAuthentication yes' >> /mnt/etc/ssh/sshd_config<enter>",
