...
#          
            ...
            amErrorAction(title="AccessibilityAnalysis",{ 
              #
              # table save in DB
              #
              if(TRUE){ 
            ...
            titleAnalysis <- paste(input$moduleSelector,": accessibilit analysis")
            amErrorAction(title=titleAnalysis,pBarFinalRm=TRUE,{    
                  amScalingUp(
                    inputSpeed              = mapSpeed,
                    inputFriction           = mapFriction,
                    inputPop                = mapPop,
