...
fluidRow(
        ...
        'archiveData' = list(
          ...
          content = tagList(
            ...
            actionButton('getArchive', amt(
			  id = "data_export_archive",
			  str = 'Export archive'
			  )),
            actionButton('btnDeleteArchive', amt(
			  id = "data_delete_archive",
			  str = 'Delete archive'
			  ))
            )
          ),
  ...
  div(class = "col-xs-12 col-md-8",
    amCenterTitle('Available data',
	  sub = "Data imported in the project or generated by AccessMod."),
	tags$div(
