...
moduleInlineBtn<-div(id='moduleSelector',
  ...
  tags$label(class="btn btn-default active btn-inline w6-100",
    tags$input(type="radio",id="ms2",name="moduleSelector",value='module_2',checked='checked'),
    icon('clock-o'),'Accessibility'
    ),
  tags$label(class="btn btn-default btn-inline w6-100",
    tags$input(type="radio",id="ms3",name="moduleSelector",value='module_3'),
    icon('hospital-o'),'Geographic coverage'
    ),
  tags$label(class="btn btn-default btn-inline w6-100 ",
