            ...
            switch (neighbor) {
              case 1:
                ...
                if(speedMap == 0){
                  ...
                  min_cost = pres_cell->min_cost + 
                    costManager(my_cost,W_cost,0,0,check_dtm,EW_fac,total_reviewed,returnPath,dnullval); 
                }
                break;
              case 2:
                E_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,E_cost,0,0,check_dtm,EW_fac,total_reviewed,returnPath,dnullval); 
                };
                break;
              case 3:
                N_dtm = costs.dtm;
                ...
                if(speedMap == 0){
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,N_cost,0,0,check_dtm,NS_fac,total_reviewed,returnPath,dnullval); 
                };
                break;
              case 4:
                S_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,S_cost,0,0,check_dtm,NS_fac,total_reviewed,returnPath,dnullval); 
                };
                break;
              case 5:
                NW_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,NW_cost,0,0,check_dtm,DIAG_fac,total_reviewed,returnPath,dnullval); 
                };
                break;
              case 6:
                NE_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,NE_cost,0,0,check_dtm,DIAG_fac,total_reviewed,returnPath,dnullval); 
                };
              ...
              case 7:
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,SE_cost,0,0,check_dtm,DIAG_fac,total_reviewed,returnPath,dnullval); 
                };
              ...
              case 8:
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,SW_cost,0,0,check_dtm,DIAG_fac,total_reviewed,returnPath,dnullval);  
                };
                break;
              case 9:
                NNW_dtm = costs.dtm;
              ...
              case 10:
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,N_cost,NE_cost,NNE_cost,check_dtm,V_DIAG_fac,total_reviewed,returnPath,dnullval);  
                }; 
                break;
              case 11:
                SSE_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,S_cost,SE_cost,SSE_cost,check_dtm,V_DIAG_fac,total_reviewed,returnPath,dnullval);  
                };
                break;
              case 12:
                SSW_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,S_cost,SW_cost,SSW_cost,check_dtm,V_DIAG_fac,total_reviewed,returnPath,dnullval);  
                };
                break;
              case 13:
                WNW_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,W_cost,NW_cost,WNW_cost,check_dtm,H_DIAG_fac,total_reviewed,returnPath,dnullval);  
                };
                break;
              case 14:
                ENE_dtm = costs.dtm;
                ...
                if(speedMap == 0){
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,E_cost,NE_cost,ENE_cost,check_dtm,H_DIAG_fac,total_reviewed,returnPath,dnullval);  
                }; 
                break;
              case 15:
                ESE_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,E_cost,SE_cost,ESE_cost,check_dtm,H_DIAG_fac,total_reviewed,returnPath,dnullval);  
                }; 
                break;
              case 16:
                WSW_dtm = costs.dtm;
                ...
                if(speedMap == 0){ 
                  ...
                  min_cost =
                    pres_cell->min_cost + 
                    costManager(my_cost,W_cost,SW_cost,WSW_cost,check_dtm,H_DIAG_fac,total_reviewed,returnPath,dnullval);  
                };
                break;
            }
