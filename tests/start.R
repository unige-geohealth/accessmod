...
amtest$script("tests/unit/test_amLogs.R")
...
amtest$script("tests/unit/test_amLeafletBasemap.R")
amtest$script("tests/unit/test_amGrassLeaflet.R")
amtest$script("tests/grass85/test_demo.R")
amtest$script("tests/grass85/test_crs_export.R")
amtest$script("tests/project_crud/test_demo.R")
amtest$script("tests/project_crud/test_legacy_am5p_wkt2.R")
